...
struct Pic {
    ...
    command: crate::cpuio::UnsafePort<u8>,

    /// The processor I/O port on which we send and receive data.
    data: crate::cpuio::UnsafePort<u8>,
}
...
impl ChainedPics {
    ...
    pub const unsafe fn new(offset1: u8, offset2: u8) -> ChainedPics {
        ChainedPics {
            pics: [
                Pic {
                    offset: offset1,
                    command: crate::cpuio::UnsafePort::new(0x20),
                    data: crate::cpuio::UnsafePort::new(0x21),
                },
                Pic {
                    offset: offset2,
                    command: crate::cpuio::UnsafePort::new(0xA0),
                    data: crate::cpuio::UnsafePort::new(0xA1),
                },
            ]
        }
    }
    ...
    pub unsafe fn initialize(&mut self) {
        ...
        let mut wait_port: crate::cpuio::Port<u8> = crate::cpuio::Port::new(0x80);
